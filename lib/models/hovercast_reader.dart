...
HovercastReader HovercastReaderFromJson(String str) =>
    HovercastReader.fromJson(json.decode(str));

String HovercastReaderToJson(HovercastReader data) =>
    json.encode(data.toJson());

class HovercastReader {
  HovercastReader({
    this.cod,
    this.message,
    this.cnt,
  ...
  factory HovercastReader.fromJson(Map<String, dynamic> json) =>
      HovercastReader(
        cod: json["cod"],
